...
# … work, commit …
cargo fmt && cargo clippy && cargo test --bin fauto   # all three green BEFORE you push
...
cargo fmt
cargo clippy
cargo test --bin fauto        # slow on Windows — run it in the background, not a 120 s shell call
