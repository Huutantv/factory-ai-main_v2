...
//! mistaken auto-supersedes can be inspected and manually reverted via `fauto memory supersede` /
...
/// A fact came back from the graveyard (`fauto memory revive`). The inverse of `supersede`, and the
