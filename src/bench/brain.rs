//! `fauto bench profile` + `fauto bench dialectic` — anti-oracle GOLDEN sets for the DERIVED brain
...
/// Entry point for `fauto bench profile`.
...
/// Entry point for `fauto bench dialectic`.
...
/// Entry point for `fauto bench health` — the three §8 measurements against hand-labeled histories.
///
