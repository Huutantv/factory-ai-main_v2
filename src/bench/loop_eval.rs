//! `fauto bench loop` — offline loop-behavior eval harness (P4 + P0 persistence).
//!
...
/// `fauto bench loop` entry point: run every scenario, print a report, exit non-zero if any regressed.
