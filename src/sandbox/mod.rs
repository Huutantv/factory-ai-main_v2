...
//! F.Auto's own code with a literal reason — a tool argument cannot name it.
//!
//! # Honesty contract
//!
...
/// Who asked for this process. Chosen by the CALL SITE (F.Auto's own code), never by the model:
...
pub enum CommandOrigin {
    ...
    McpStdio,
    /// An F.Auto-internal spawn whose program AND arguments are F.Auto-controlled (git plumbing,
