...
//! lives here rather than in a backend: a child process simply never receives F.Auto's provider
...
/// credential-adjacent even where a single name looks harmless) and every `AIZEN_*` (F.Auto's own
