//! Project-zone inventory + migration (`fauto zone migrate`, the startup legacy-zone hint).
//!
...
/// artifacts are entry tags still shows up in `fauto zone migrate`'s full plan). Returns the
