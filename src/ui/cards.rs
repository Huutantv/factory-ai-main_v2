//! Baked colour feature-cards — the six illustrated panels that describe what F.Auto is. Unlike the
...
//!
//!   * startup — bare `fauto` shows ONE card, rotating to the next on each launch (a persisted
