...
/// How many saved sessions still carry a LEGACY zone slug — for `fauto zone migrate`'s plan.
...
/// session leg of `fauto zone migrate`. Without it, a moved/re-cloned checkout (or a pre-fix
...
///
/// Age-gated because the name is not enough: another fauto window may be mid-write RIGHT NOW, and its
