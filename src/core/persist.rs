...
///
/// Callers that need coordination against other compliant F.Auto writers should also hold the
/// appropriate resource/workspace lock. This CAS remains the final defense against editors, old
/// binaries, and other programs that do not honor F.Auto's lock protocol.
