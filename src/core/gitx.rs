...
/// Harden an INTERNAL git invocation against repository-controlled execution and hangs. F.Auto's
...
/// checkout is untrusted input, and "fauto made a checkpoint" must not be a code-execution event.
