...
F.Auto runs shell commands, edits files, makes network requests, and handles provider API keys, so
...
F.Auto's threat model documents several deliberate safety layers: an OS sandbox around
